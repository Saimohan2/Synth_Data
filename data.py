...
order_ids = np.arange(n//2, 2250000)
customer_ids = np.random.randint(1, num_customers+1, size = n)
...
orders_df.to_parquet("orders_04-22.parquet", engine = "pyarrow", index = False)